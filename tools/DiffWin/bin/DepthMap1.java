...
Vector<Vector3D> intersections = segmesh.findZIntersections(x, y);
double zm=bounds.Zmin;
for(Vector3D intersection:intersections) {
if(intersection != null) {
if(intersection.z > zm) {zm = intersection.z;};
} else {
System.out.println("Null intersection: " + "(" + x + "," + y + ")"); } }
